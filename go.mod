...
require (
	...
	github.com/openshift/cluster-api-actuator-pkg/testutils v0.0.0-20250917015549-1770611ea9b2
...
// Temporary fix for structured-merge-diff compatibility issue
// This project has dependency conflicts between OpenShift (using v4) and Kubernetes (using v6)
exclude sigs.k8s.io/structured-merge-diff/v6 v6.2.0
